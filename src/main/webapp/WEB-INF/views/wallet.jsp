	...
	<div class="wallet-container">
		...
		<div class="balance-wrapper vertical">
			...
			<div class="balance-row">
				...
				<span class="value">${String.format("%.8f", wallet.usdtBalance)} USDT</span>
			<div class="profit-rate" style="color: ${wallet.profitRateValue >= 0 ? 'green' : 'red'};">
		...
		<div id="resetModal" class="modal">
			<div class="modal-content">
				...
				<p style="text-align: left;"><strong style="color: red;">RESET</strong>을 입력하세요.</p>
				<input type="text" id="resetConfirmInput" placeholder="RESET 입력" style="display: block; margin: 10px 0;" />
				<div class="modal-buttons">
